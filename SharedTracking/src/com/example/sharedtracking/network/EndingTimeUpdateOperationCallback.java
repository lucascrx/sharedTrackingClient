...
public class EndingTimeUpdateOperationCallback implements INetworkOperationCallback{
	
	/**Listener to wake up at network operation end*/
	private ISessionUpdateListener listener;
	
	public EndingTimeUpdateOperationCallback(ISessionUpdateListener listener) {
	...
	public void onNetworkActionDone(String result) {
		...
		this.listener.onEndingTimeUpdated(response);
	}
